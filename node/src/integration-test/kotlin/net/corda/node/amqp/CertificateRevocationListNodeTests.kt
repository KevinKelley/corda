...
class CertificateRevocationListNodeTests {
    ...
    @Test
    fun `AMPQ Client to Server connection fails when servers's certificate is revoked and crlCheckSoftFail is enabled`() {
    ...
    @Test
    fun `AMPQ Client to Server connection succeeds when CRL cannot be obtained and crlCheckSoftFail is enabled`() {
        val crlCheckSoftFail = true
    ...
    @Test
    fun `Revocation status chceck fails when the CRL distribution point is not set and crlCheckSoftFail is disabled`() {
        val crlCheckSoftFail = false
    ...
    @Test
    fun `Revocation status chceck succeds when the CRL distribution point is not set and crlCheckSoftFail is enabled`() {
        val crlCheckSoftFail = true
        val (amqpServer, _) = createServer(
                serverPort,
                crlCheckSoftFail = crlCheckSoftFail,
