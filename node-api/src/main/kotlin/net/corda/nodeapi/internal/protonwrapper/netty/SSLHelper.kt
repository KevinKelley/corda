...
internal fun initialiseTrustStoreAndEnableCrlChecking(trustStore: KeyStore, softFail: Boolean): ManagerFactoryParameters {
    ...
    revocationChecker.options = EnumSet.of(
            PKIXRevocationChecker.Option.PREFER_CRLS, // Prefer CRL over OCSP
